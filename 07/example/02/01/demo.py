...
df1=pd.concat([df['2019-02_创建一个Series对象'],df['2020-02_创建一个Series对象']])
df1=df1[df1['商品名称']=='零基础学Python（全彩版）']
df1=df1[['北京','上海','广州','成都','武汉','沈阳','西安']]
df2=df1.T   #行列转置
x=np.array([0,1,2,3,4,5,6])
y1=df2['2019-02_创建一个Series对象-01_读取Excel数据']
y2=df2['2020-02_创建一个Series对象-01_读取Excel数据']
#同比增长率
df2['rate']=((df2['2020-02_创建一个Series对象-01_读取Excel数据']-df2['2019-02_创建一个Series对象-01_读取Excel数据'])/df2['2019-02_创建一个Series对象-01_读取Excel数据'])*100
y=df2['rate']
print(y)
width =0.25                                     #柱子宽度
